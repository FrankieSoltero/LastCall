...
export default function GeneralAvailabilityPage() {
    ...
    const handleSave = async () => {
        setSaving(true);
        try {
            const payload: UpdateGeneralAvailabilityRequest = {
                availability: schedule.map(day => ({
                    dayOfWeek: day.dayOfWeek,
                    status: day.status,
                    startTime: day.startTime !== 'UNAVAILABLE' ? day.startTime : undefined,
                    endTime: day.status !== "UNAVAILABLE" ? day.endTime : undefined
                }))
            };

            await api.updateMyGeneralAvailability(payload);
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>Set your preferred standard hours.</Text>
            </View>
