        ...
        <>
          <View style={styles.sideBar}>
            <TouchableOpacity style={styles.toggleButton} onPress={toggleSideBar}>
              ...
              <TouchableOpacity onPress={() => router.push(`/protected/adminOrganization/${orgID}` as Href<string>)}>
                <View style={styles.iconWithText}>
                  <Ionicons style={styles.sideBarLink} name="beer" size={20} />
                  <Text style={styles.sideBarLink}>Dashboard</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => router.push(`/protected/adminOrganization/${orgID}/scheduleTemp` as Href<string>)}>
                <View style={styles.iconWithText}>
                  <Ionicons style={styles.sideBarLink} name="beer" size={20} />
                  <Text style={styles.sideBarLink}>Schedule Templates</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => router.push(`/protected/adminOrganization/${orgID}/createSchedule` as Href<string>)}>
                <View style={styles.iconWithText}>
                  <Ionicons style={styles.sideBarLink} name="beer" size={20} />
                  <Text style={styles.sideBarLink}>Create Schedule</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => router.push(`/protected/adminOrganization/${orgID}/employee` as Href<string>)}>
                <View style={styles.iconWithText}>
                  <Ionicons style={styles.sideBarLink} name="beer" size={20} />
                  <Text style={styles.sideBarLink}>Employees</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => router.push(`/protected/adminOrganization/${orgID}/pendingEmployee` as Href<string>)}>
                <View style={styles.iconWithText}>
                  <Ionicons style={styles.sideBarLink} name="beer" size={20} />
