...
const CreateSchedule: React.FC = () => {
 ...
 return (
   <View style={{ padding: 20 }}>
     ...
     <Text style={{ fontSize: 22, fontWeight: "bold", marginBottom: 10, color: "black" }}>
       Create Schedule
     </Text>
     ...
     {!numDays && (
       <>
         <Text style={{ color: "black" }}>Enter how many days the schedule should last:</Text>
         <TextInput
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 20,
    backgroundColor: "#111d3e", // dark background
  },
  header: {
    fontSize: 24,
    fontWeight: "bold",
